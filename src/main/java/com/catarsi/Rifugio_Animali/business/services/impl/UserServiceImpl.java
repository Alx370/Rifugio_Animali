...
public class UserServiceImpl implements UserService {
    ...
    public int create(UserRequest userRequest) {
        ...
        userRequest.getPasswordHash().ifPresentOrElse(user::setPasswordHash, () -> user.setPasswordHash(null));
        ...
        userRequest.getRole().ifPresentOrElse(user::setRole, () -> user.setRole("USER"));
    ...
    public void update(UserRequest userRequest, int id) {
        ...
        userRequest.getPasswordHash().ifPresent(user::setPasswordHash);
